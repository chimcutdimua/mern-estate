                ...
                <div>
                    ...
                    <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                        ...
                        <div className='flex gap-4'>
                            ...
                            {listing.offer && (
                                <p className='bg-green-900 w-full max-w-[200px] p-1 rounded-md text-white text-center'>
                                    ${listing.discountedPrice.toLocaleString('en-US')} discount
                                </p>
                            )}
                        </div>
                        ...
                        {currentUser && listing?.userRef !== currentUser?._id && (
                            <button onClick={() => setContact(true)} className='bg-slate-700 uppercase hover:opacity-95 p-3 text-white rounded-lg'>
                                Contact landlord
                            </button>
                        )}
